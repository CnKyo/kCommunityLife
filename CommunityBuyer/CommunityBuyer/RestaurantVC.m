...
//    [self.tableView setTableHeaderView:headView];
    ...
    choseView.frame = CGRectMake(0, -(DEVICE_InNavBar_Height-150), DEVICE_Width, DEVICE_InNavBar_Height-150);
...
- (IBAction)LeftClick:(id)sender {
    ...
    if (isOpen) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            rect2.origin.y = DEVICE_NavBar_Height+40;
...
- (void)CloseChoseView{
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        rect2.origin.y = -(DEVICE_InNavBar_Height-150);
        choseView.frame = rect2;
