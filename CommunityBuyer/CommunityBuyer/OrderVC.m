...
- (void)viewDidLoad {
    ...
    [self loadTableView:CGRectMake(0, 64+55, DEVICE_Width, DEVICE_InNavTabBar_Height-55) delegate:self dataSource:self];
...
- (void)initCell:(OrderCell *)cell andOrder:(SOrderObj *)order{
    ...
    NSMutableAttributedString *attriString2 = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"¥%.2f元",order.mTotalFee]];
