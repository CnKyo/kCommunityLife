...
- (void)layoutSubviews
{
    ...
    CGFloat x = (self.sd_width - size.width) * 0.5-10;
    ...
    _pageControl.frame = CGRectMake(x+30, y+20, size.width, size.height);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.imageView setImageWithURL:[NSURL URLWithString:self.imagesGroup[itemIndex]] placeholderImage:[UIImage imageNamed:@"icon_nopic"]];
