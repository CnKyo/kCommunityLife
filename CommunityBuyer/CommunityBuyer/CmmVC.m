...
-(void)updatePage
{
    ...
    NSArray* allgoodsimgs = _mtagOrder.mGoodsImages;
    ...
    NSString* strv = [NSString stringWithFormat:@"共%lu件",allgoodsimgs.count];
...
-(void)updateCheck
{
    _mcheck.image = _bchecked ? [UIImage imageNamed:@"checkgou"] : [UIImage imageNamed:@"checknogou"];
}
