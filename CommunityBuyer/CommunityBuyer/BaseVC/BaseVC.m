...
- (void)setAddressTitle:(NSString *)AddressTitle
{
    ...
    CGRect rect = self.navBar.titleLabel.frame;
    rect.size.width = 16*AddressTitle.length;
    
    self.navBar.ImageV = [[UIImageView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.navBar.titleLabel.frame), self.navBar.titleLabel.frame.origin.y, 13, 8)];
    self.navBar.ImageV.center = self.navBar.titleLabel.center;
    CGRect rect2 = self.navBar.ImageV.frame;
    rect2.origin.x = CGRectGetMaxX(self.navBar.titleLabel.frame);
    self.navBar.ImageV.frame = rect2;
